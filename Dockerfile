...
RUN apt-get update -qq && apt-get install -qq -y wget && \
	...
	wget --header="Authorization: Bearer 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"  -q https://maven.pkg.github.com/reportportal/service-jobs/com/epam/reportportal/service-jobs/5.4.0/service-jobs-5.4.0-exec.jar
